...
int ts=scores.getInt("totalscore");
...
<tr><th colspan="9" style="text-align:center"><label style="font-size:40px; background-color:red;color:white">Narrative Quality Review</label></th>
