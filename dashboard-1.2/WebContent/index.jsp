...
<table width=100%>
  ...
  <ul class="dropdown-menu dropdown-menu-right">
    ...
    <li><a href="http://www.cghr.org:8080/sl-support/login/" target="sl-support">Sl-Support</a></li>
  </ul>
  </div>
...
<tr> <td colspan=1 width=15%> <h4>Maps</h4></td ><td width=15%></td>
<td> <a class="btn btn-default"  title="maps" href="maps/map-ph2.html">  <img class=" rounded-circle dashicon" src="img/map.jpg"><br>Phase 2 maps</a><td><a class="btn btn-default" href="survey_monitoring_dashboard.jsp?tabs=areamap"> <img class="rounded-circle dashicon" src="img/mapreport.jpg"><br>Reports </a></td>
