...
Object username=request.getAttribute("user");
 ...
 Object date=new Date().getDate();
	...
	//fieldsObj.put("probing_feedback", request.getParameter("profeedback"));
	...
	int totalProbingScore=op.scoreProbing(probing,ja);
	...
	scoresObj.put("q4",q4score);scoresObj.put("q5",q5score);scoresObj.put("q6",q6score);scoresObj.put("q7",q7score);scoresObj.put("totalscore",totalScore);
